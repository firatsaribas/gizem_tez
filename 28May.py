...
suppliers_assignments = assign_suppliers(supply_dict, beta_dict, gamma_dict, theta_dict, vehicle_owners_df,
                     hub_targets, F_set, K_set, B_set, S_set, T_set)
...
print(f"Çözüm {end_time - start_time:.2f} saniyede tamamlandı.")
